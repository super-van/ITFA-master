...
class PaperModel(nn.Module):
    ...
    def forward(self, x, n, k, q):
        ...
        pre_sim = euclidean_dist(query, proto)
        ...
        for cls in range(n):
            ...
            # 一维
            self_sim = euclidean_dist(proto[cls].unsqueeze(0), self_proto).squeeze(0)
        ...
        query_sim = euclidean_dist(query, query)
        ...
        sim = euclidean_dist(adapted_query, adapted_proto)
        return sim